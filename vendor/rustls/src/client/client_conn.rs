...
pub struct ClientConfig {
    ...
    /// Optional ClientHello shape override (dpi-detector patch).
    ///
    /// `None` (the default) is upstream rustls behaviour. When set, the
    /// cipher-suite list, `supported_groups`, `signature_algorithms`, ALPN,
    /// extension order and a set of verbatim extra extensions are taken from
