...
pub(crate) fn messages() -> Messages {
    Messages {
        ...
        cfg_warn_skipped_rows: "{}: invalid rows skipped, using the rest",
        ...
        warn_unknown_flag_value: "Warning: unknown {} '{}', using {}",
        ...
        domains_load_failed: "Could not build the target list {} — a run with no targets measures nothing, so it stops",
