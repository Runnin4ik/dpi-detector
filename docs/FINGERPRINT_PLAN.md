...
|---|---|---|
| нет `encrypted_client_hello` (65037) | `chrome120/131/131android/133/136`, `firefox`, `firefox135/144`, `tor145` | синтезированное тело серверы с ECH отвергают; JA4 на одно расширение короче |
| порядок расширений фиксирован | те же хромы 110+ | настоящий Chrome перемешивает их каждое соединение; устойчив только JA4 |
| `compress_certificate` без `zstd` | `firefox`, `firefox135/144`, `tor145` | в сборке нет zstd-распаковщика |
| долей ключа меньше | `firefox`×3 (2 против 3), `tor145` (1 против 3) | отправляем нужные, а не `--tls-key-shares-limit` |
| нет `8:1` / `9:1` | `safari18`, `safari184ios`, `safari260`, `safari260ios` | этих настроек не пишут ни `h2`, ни `hyper` (`vendor/h2/README-PATCH.md`) |
