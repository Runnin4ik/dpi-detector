...
```bash
docker run --rm -it ghcr.io/runnin4ik/dpi-detector:3.7.0
```
...
*   **[Скачать для Windows 10 / 11](https://github.com/Runnin4ik/dpi-detector/releases/download/v3.7.0/dpi_detector_v3.7.0_win10.exe)**
*   **[Скачать для Windows 7 / 8](https://github.com/Runnin4ik/dpi-detector/releases/download/v3.7.0/dpi_detector_v3.7.0_win7.exe)**
...
*   **[Скачать для Apple Silicon (M1–M4)](https://github.com/Runnin4ik/dpi-detector/releases/download/v3.7.0/dpi_detector_v3.7.0_macos_arm64)**
*   **[Скачать для Intel](https://github.com/Runnin4ik/dpi-detector/releases/download/v3.7.0/dpi_detector_v3.7.0_macos_intel)**
...
```bash
xattr -cr dpi_detector_v3.7.0_macos_arm64
chmod +x dpi_detector_v3.7.0_macos_arm64
./dpi_detector_v3.7.0_macos_arm64
```
