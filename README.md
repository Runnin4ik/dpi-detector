...
[![Release](https://img.shields.io/badge/Release-v5.0.0--alpha.1-blue.svg)](https://github.com/Runnin4ik/dpi-detector/releases)
...
Опции:
  ...
  -c, --concurrency <COUNT>      Количество параллельных потоков (1, 5, 20, 50, 100) [по умолч.: 50]
      ...
      --batch                    Неинтерактивный режим (включается автоматически при наличии флагов)
